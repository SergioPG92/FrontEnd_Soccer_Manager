...
function Footer() {
  return (
    <footer className="bg-dark-verde text-white py-2  font-fuente2">
      <div className="container mx-auto px-4 flex justify-between items-center text-center gap-4">
        {/* Parte izquierda del footer */}
        <div className="flex flex-col items-center justify-center">
          <p className="text-m">
            © 2025 Soccer Manager  </p>Este trabajo está bajo una licencia
            <a href="https://creativecommons.org/licenses/by-sa/4.0/deed.es">Creative
            Commons Atribución-CompartirIgual 4.0 Internacional (CC BY-SA 4.0)</a>
          <a href="https://creativecommons.org/licenses/by-sa/4.0/deed.es">
          <img src="/imagenes/CC_BY-SA_logo.svg" alt="" /></a>
